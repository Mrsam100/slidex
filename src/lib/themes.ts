...
export const THEMES: Theme[] = [
  ...
  { id: 'dark',     name: 'Dark',     bgColor: '#0A0A0A', textColor: '#CCCCCC', headlineColor: '#FFFFFF', accentColor: '#009E91', fontFamily: 'DM Sans', borderRadius: '8px' },
  {
    ...
    fontFamily: 'DM Sans',
    borderRadius: '12px',
    bgGradient: 'linear-gradient(135deg, #0F172A 0%, #1E293B 25%, #7C2D12 50%, #EA580C 75%, #F97316 100%)',
  },
  {
    id: 'fun',
    name: 'Fun',
    ...
    fontFamily: 'DM Sans',
    borderRadius: '20px',
    bgGradient: 'linear-gradient(135deg, #FFF7ED 0%, #FEF3C7 30%, #FECDD3 60%, #E0E7FF 100%)',
    emojiSet: ['🚀', '💡', '🎯', '✨', '🔥', '💪', '🎉', '🌟', '⚡', '🏆', '💎', '🌈', '🎨', '🧠', '❤️', '👀', '🤩', '😎', '🙌', '📌'],
  },
]
